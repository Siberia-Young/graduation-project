...
file_name = "data/tm/需求2_天猫_2023-11-22_19-38-08_(1903).xlsx"
num = 6
...
try:
    ...
    for row in range(start_row, end_row + 1):
        ...
        if not sentence is None and (check_keywords(sentence) or (check_keywords1(sentence) and check_keywords2(sentence))):
            list.append(row)
