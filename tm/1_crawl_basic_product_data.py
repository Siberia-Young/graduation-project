...
def scrape_multiple_pages(keyword, start_page, end_page, supplement):
        ...
        for (index, element) in enumerate(elements, start=1):
            ...
            try:
                ...
                if(len(goods_prices1) != 0 and len(goods_prices2) != 0 and len(goods_nums) != 0):
                    ...
                    goods_num = convert_string_to_number(goods_nums[0].text.replace('人付款',''))
...
if __name__ == "__main__":
    ...
    end_page = 100
    supplement = False
    [total_num, record_num] = scrape_multiple_pages(keyword, start_page, end_page, supplement)
