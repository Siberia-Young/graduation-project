...
file_name = "data/tb/merge/merge_2_3.xlsx"
num = 2
base_file_name = 'src/tb/data_files/shop_body_info/shop_body_info.json'
row_height = 40
column_width = 14

def import_store_information(file_name,base_file_name = 'src/tb/data_files/shop_body_info/shop_body_info.json'):
    # 打开需读取的excel表
