...
confirm_json_path = "src/pdd/data_files/confirm_filter.json"
...
def filter_by_whitelist(keywords1, keywords2, keywords3, file_name):
    ...
    try:
        ...
        for row in range(start_row, end_row + 1):
            ...
            if convert_string_to_number(goods_nums) >= 200 and shop_name not in white_list and shop_name not in recent_list and check_keywords(goods_title, keywords1, keywords2, keywords3):
